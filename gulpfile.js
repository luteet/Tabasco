...
function images() {
	return src(['app/img/**/*.*', '!app/img/**/*.webp', '!app/img/**/*.svg', '!app/img/**/*.gif'])
	.pipe(newer('dist/img'))
...
function scriptsLib() {
	return src([
		...
		'node_modules/@splidejs/splide-extension-intersection/dist/js/splide-extension-intersection.min.js',
